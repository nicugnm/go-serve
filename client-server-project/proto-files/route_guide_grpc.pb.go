...
func (x *routeGuideRouteChatClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *routeGuideRouteChatClient) Recv() (*Response, error) {
	m := new(Response)
...
func (x *routeGuideRouteChatServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *routeGuideRouteChatServer) Recv() (*Request, error) {
	m := new(Request)
...
var RouteGuide_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto-files/route_guide.proto",
}
